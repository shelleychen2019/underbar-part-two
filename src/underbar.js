(function () {
  ...
  _.memoize = function (func) {
    ...
    function hash(args) {
      ...
      // return args[0] + ',' + args[1]; //this will be an issue for objects. oebject + object will give {object Object}, {object, Object}
    }
    //json.stringify
    /* END SOLUTION */
  };
  console.log({ hi: 'hello' } + ',' + { hi: 'hello2' })
  ...
  _.delay = function (func, wait) {
    ...
    let arg_array = []
    arg_array.push(arg1, arg2)
    //args is passed in as an array
  ...
  _.invoke = function (collection, functionOrKey, args) {
    /* START SOLUTION */
    _.each(collection, function(collection, args){
  ...
  _.intersection = function () {
    /* START SOLUTION */
    // sort arguments by length of array and use shortest for comparison, sorting doesn't make a difference
    // arguments.sort(arguments.length)
    //convert arguments to an array
    let arrays = [].slice.call(arguments)
    // check each element in array against other arra and return common array,
    //check common array with next array
    //does array have duplicates, array return unique values
    // _.reduce(arrays, function (accumulator, arg) {

    //make the array[0] or the shortest array unique before truth array
    const unique_array = _.uniq(arrays[0]);
    console.log(unique_array)
    //use const if variable not gonna change
    const truth_array = _.map(
      unique_array, function (element) {
      //compare every item of array with item of next array
      
      let every_call = _.every(
        arrays, function (array) {
        console.log('see how contains works', array, element, _.contains(element))
        return _.contains(array, element)

      }
      )
      console.log('check every function', every_call, element)
      return every_call
    }
    )
    let result = []
